...
@OpenAPIDefinition(
		  info =@Info(
		    title = "Api para la medición de la polución mediante estaciones",
		    version = "v1",
		    contact = @Contact(
		    ...
		    description = "Api que nos permite consultar el estado de polución que cada estación nos ofrece"
		  ),
		  servers = @Server(
		    url = "/",
