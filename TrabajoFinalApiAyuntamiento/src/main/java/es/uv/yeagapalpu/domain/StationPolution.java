...
public class StationPolution implements Serializable {
	...
	public StationPolution() {}

	public StationPolution(String id_station, float nitricOxides, float nitrogenDioxides, float vOCs_NMHC, float pM2_5,
